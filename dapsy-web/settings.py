...
DEBUG = True
ALLOWED_HOSTS = ["*.onionreads.com", ".vercel.app", ".now.sh", "127.0.0.1", "*.onrender.com", "cognigaurd.onrender.com", "13.201.23.57","chrome-extension://dmgfpkknhfmhijobnoookephiafkmjog","localhost",'*','10.0']
