...
DEBUG = True
ALLOWED_HOSTS = ["cogniguard.onionreads.com","*.onionreads.com", ".vercel.app", ".now.sh", "127.0.0.1", "*.onrender.com", "cognigaurd.onrender.com", "13.201.23.57","chrome-extension://dmgfpkknhfmhijobnoookephiafkmjog","localhost",'*','10.0']
...
WSGI_APPLICATION = 'dapsy.wsgi.application'
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",
    "http://localhost:8000",
    "chrome-extension://dmgfpkknhfmhijobnoookephiafkmjog"
